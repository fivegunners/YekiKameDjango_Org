...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ["fullname", "email", "phone", "password", "is_active", "is_admin"]
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ["phone", "fullname",  "email", "is_admin", "is_active"]
    list_filter = ["is_admin"]
    fieldsets = [
        ("اطلاعات شخصی", {"fields": ["email", "phone"]}),
        ("نام کاربر", {"fields": ["fullname"]}),
    ...
    add_fieldsets = [
        (
            ...
            {
                "classes": ["wide"],
                "fields": ["email", "fullname", "password1", "password2", "phone"],
            },
        ),
    ]
    search_fields = ["phone"]
